...
async function tryToRefreshChatMessagesStoring(now){
    ...
    async function tryLockRefresh(){
        try{
            ...
            log.error('OP Error', { code: 1128, err: { code: err.code, command: err.command, message: err.message } });
            throw err;
        }
    ...
    async function getBatchOfOutdatedDocuments(){
        try{
            ...
            log.error('Database Error', { code: 1129, err: { message: err.message, name: err.name } });
            throw new ErrorResponse(1129, 'Database Error');
        }
    ...
    async function removeOutdatedDocuments(){
        try{
            ...
            log.error('Database Error', { code: 1130, err: { message: err.message, name: err.name } });
            throw new ErrorResponse(1130, 'Database Error');
        }
    }
...
async function getNewMessageSequenceNumber(inGroup){
    try{
        ...
        log.error('Database Error', { code: 1131, err: { message: err.message, name: err.name } });
        throw new ErrorResponse(1131, 'Database Error');
    }
}
async function persistMessage(theMessage, byHumanId, inGroup, messageSequenceNum, messageCat){
    ...
    async function getOrCreateNewGroup(){
        try{
            ...
            log.error('Database Error', { code: 1132, err: { message: err.message, name: err.name } });
            throw new ErrorResponse(1132, 'Database Error');
        }
    ...
    async function doPersist(){
        try{
            ...
            log.error('Database Error', { code: 1133, err: { message: err.message, name: err.name } });
            throw new ErrorResponse(1133, 'Database Error');
        }
    }
...
async function listMessages(skip, limit, fromGroup, fromCat){
    ...
    async function getTargetGroupId(){
        try{
            ...
            log.error('Database Error', { code: 1134, err: { message: err.message, name: err.name } });
            throw new ErrorResponse(1134, 'Database Error');
        }
    ...
    async function getMostRecentMessage(){
        try{
            ...
            log.error('Database Error', { code: 1135, err: { message: err.message, name: err.name } });
            throw new ErrorResponse(1135, 'Database Error');
        }
    ...
    async function doList(){
        try{
            ...
            log.error('Database Error', { code: 1136, err: { message: err.message, name: err.name } });
            throw new ErrorResponse(1136, 'Database Error');
        }
